...
const DirectBuy = ({ route, navigation }) => {
  ...
  useEffect(()=>{
    ...
    fetch("https://upfrica-staging.herokuapp.com/api/v1/addresses?page=1", requestOptions)
...
{/* 
              ...
              <View style={{marginVertical:20, marginHorizontal:15}}>
               {
                addresses && addresses.map((address,index)=>(<View key={index} 
                  style={{
                  ...
                  <View style={{flexDirection:'row'}}><BouncyCheckbox
                    size={20}
                  ...
                  <View style={{flexDirection:'row'}}>
                    ...
                    }}>{address?.address_data?.town},</Text>
                    <Text style={{
                      ...FONTS.font,
                      ...FONTS.fontTitle,
                      color: colors.title,
                    }}>{address?.address_data?.country}</Text>
                  </View>
                  <View style={{flexDirection:'row'}}>
                    <Text style={{
                      ...FONTS.font,
                      ...
                      color: colors.title,
                      marginRight:3,
                    }}>{address?.address_data?.postcode},</Text>
                  
                    <Text style={{
                      ...FONTS.font,
                      ...FONTS.fontTitle,
                      color: colors.title,
                    }}>{address?.address_data?.address_line_1}</Text>
                  </View>
                  <Text style={{
                    ...FONTS.font,
                    ...FONTS.fontTitle,
                    color: colors.title,
                  }}>Contact: {address?.address_data?.phone_number}</Text>
